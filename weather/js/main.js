...
function loadWeather() {
    ...
    if (zip===''){zip="84653";}
    var conditionsPath= "http://api.wunderground.com/api/ce354a319f213c36/conditions/q/"+zip+".json";
    var forecastPath ="http://api.wunderground.com/api/ce354a319f213c36/forecast/q/"+zip+".json";
    //GET THE CONDITIONS
